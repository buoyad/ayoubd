...
export const Callout = (props: Props) => {
    let icon = typeof props.icon === 'string' ? <Icon name={props.icon as IconName} /> : props.icon
    return <Box row gap="none" style={{ ...styles.container, ...props.style }} className={props.className}>
