...
export const ZoomEntry = () => (
  ...
  >
    <Text>Bringing end-to-end encryption to Zoom products.</Text>
    <ul>
      <li>
        <Text bold inline>
        ...
        <Text inline>
          Architected and deployed the intermediate CA that stores trusted
          server signing keys in hardware security modules (HSMs), enabling
          potential clients with high security compliance requirements to
          consider Zoom products. Implemented an ACME client that interfaces
          with DigiCert CA and automatically rotates certificates.
        </Text>
        <Text>
          As described in section 7.6.1 of the{' '}
          <Link href="https://github.com/zoom/zoom-e2e-whitepaper">
      ...
      <li>
        ...
        <Text inline>
          System that allows keyservers to communicate with each other across
          regions, allowing customers with data residency requirements to
          upgrade to end-to-end encrypted products.
        </Text>
      </li>
      <li>
        <Text bold inline>
...
export const KeybaseEntry = () => (
  ...
  >
    <Text>
      At Keybase I was mainly on the desktop team working on the cross-platform
      Keybase app. One codebase was used to build apps for macOS, Windows,
    ...
    <ul>
      <li>
        ...
        <Text inline>
          Led a team of 4 engineers in re-implementing 30+ screens using a
          cohesive design system. Worked closely with design and core teams to
          create a consistent library of 100+ components, hooks, and API
          protocols to serve as the foundation for future development.
        </Text>
      </li>
      <li>
        <Text bold inline>
        ...
        <Text inline>
          Implemented the cryptographically sound exploding messages UI, which
          allows users to send messages that disappear after a set time.
