...
export async function generateMetadata(
  ...
  const post = (await getProjectsContent()).find(
...
const HeroImage = (props: HeroProps) => {
  const {
    src,
    alt = 'a large image representing this project',
    mode = 'contain',
    style,
  } = props
...
const styles = styleSheet({
  outer: {
    ...
    gridTemplateColumns:
      '1fr min(calc(100vw - 2*var(--content-padding-horizontal)), 120ch) 1fr',
  },
  inner: {
    gridColumn: 2,
    flexWrap: 'wrap',
