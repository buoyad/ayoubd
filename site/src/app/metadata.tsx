...
export const metadata: Metadata = {
    ...
    keywords: ['software engineer', 'product engineer', 'frontend engineer', 'frontend developer', 'fullstack engineer', 'fullstack developer', 'full stack engineer', 'full stack developer', 'software developer', 'security engineer', 'react developer'],
    formatDetection: {
        telephone: false,
        email: false,
        address: false
