...
Goal is to animate smoothly between two icons. By "smoothly" here we mean:

- make one shape actually _transform_ into the other, i.e. don't fade between
  them or animate one sliding in to take the other's place
-
